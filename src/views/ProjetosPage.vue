  ...
  <div>
    ...
    <div v-if="cadastro" class="cadastro" @click="exporProjeto">
      ...
      <div class="cadastro__campos">
        ...
        <div style="width: 100%; justify-content: center; display: flex;"><button class="blue_btn adicionar">Adicionar aluno <span style=" font-size: 28px;">🞢</span></button>
        </div>
        <hr>
    ...
    <section class="section__projetos">
      ...
      <div class="container-projetos">
        <div
          ...
          v-for="(project, index) in limitedItems" :key="index" @click="upPopup($event, index, project.categoria)">
